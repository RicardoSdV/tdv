...
class SessionManager:
    def __init__(self, db: 'DB', entity_cache: 'EntityCache', account_service: 'AccountService',
        portfolio_service: 'PortfolioService', pfol_share_service: 'PortfolioShareService',
        pfol_option_service: 'PortfolioOptionService', strike_service: 'StrikeService',
        expiry_service: 'ExpiryService', logger: 'Logger'
    ) -> None:
    ...
    def login(self, account_name: str, password: str) -> 'Session':
        ...
        """
        self.__logger.debug('Login', account_name=account_name, password=password)
    ...
    def logout(self, session_id: int) -> None:
        ...
        """
        self.__logger.debug('Logout', session_id=session_id)
