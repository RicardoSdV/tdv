from typing import List, TYPE_CHECKING, Iterator, Iterable, Sequence
...
class StrikeService:
    ...
    def get_else_create_strikes(
        self, expiry_id: int, strike_prices: Sequence[float], contract_size_names: Iterable[str], conn: Connection
    ) -> List[Strike]:
